...
<p
:class="dailyQuestCompleted ? 'text-green-600 text-shadow-green' : 'text-red-600 text-shadow-red'"
...
<section
class="flex md:justify-center md:items-center flex-col relative"
>
<div
